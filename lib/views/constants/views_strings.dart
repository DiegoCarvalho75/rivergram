...
@immutable
class ViewsStrings {
  static const appName = 'Rivergram!';

  static const welcomeToAppName = 'Welcome to ${ViewsStrings.appName}';

  static const youHaveNoPosts = '''You have not made a post yet.
Press either the video-upload or the photo-upload buttons to the top of the screen in order to upload your first post!''';
